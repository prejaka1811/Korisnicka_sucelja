...
const Navbar = () => {
  ...
  return (
    <nav style={{ margin: 0, padding: 0, display: 'flex', width: '100%', maxHeight: '8vh', position: 'relative', backgroundColor: '#F8BE33' }} className="p-4 flex items-center justify-center">
      <div className="container mx-auto flex items-center justify-between w-full">
        {/* Adding overflow: hidden to cut the Logo */}
        <div style={{ overflow: 'hidden', width: '120px', height: '60px' }}>
          {/* Adding a style prop to the Logo component */}
