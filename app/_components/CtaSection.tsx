...
const CtaSection = () => (
  <div className="bg-[#ECECEC] w-full">
    <section className="pb-8 lg:container flex flex-col lg:flex-row justify-center items-center gap-20 w-full">
      ...
      <div className="relative h-full w-full lg:brightness-100 lg:saturate-100 lg:flex-grow hidden lg:block flex-1">
        <Image
          src={image}
          placeholder="blur"
          alt={"CTA image"}
      ...
      <div className="px-5 lg:px-0 flex flex-col gap-5 max-w-lg flex-1">
        <div>
        ...
        <p className="text-black text-center font-Inika font-bold text-2xl leading-normal tracking-wide lg:text-xl md:text-lg sm:text-base">
          ...
          along the way. Start sharing your culinary journey with us today.
        </p>
